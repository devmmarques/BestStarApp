...
internal enum FontFamily {
  internal enum Gotham {
    internal static let black = FontConvertible(name: "Gotham-Black", family: "Gotham", path: "Gotham-Black.otf")
    ...
    internal static let thin = FontConvertible(name: "Gotham-Thin", family: "Gotham", path: "Gotham-Thin.otf")
    internal static let thinItalic = FontConvertible(name: "Gotham-ThinItalic", family: "Gotham", path: "Gotham-ThinItalic.otf")
    internal static let all: [FontConvertible] = [black, bold, bookItalic, light, thin, thinItalic]
  }
