...
final class ErrorView: UIView {
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.font = UIFont(font: FontFamily.Gotham.light, size: 18)
        label.accessibilityIdentifier = "labelTitleError"
        label.textColor = ColorName.blueApp.color
    ...
    private lazy var buttonTryAgain: UIButton = {
        ...
        button.setTitleColor(ColorName.blueApp.color, for: .normal)
        button.titleLabel?.font = UIFont(font: FontFamily.Gotham.light, size: 14.0)
        button.layer.borderColor = ColorName.blueApp.color.cgColor
        return button
    }()
